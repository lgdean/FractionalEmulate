...
Many of the above examples result in rolling,
...
From a given starting setup, we show 3 variants of the call:
...
Box Transfer require breathing, resulting in a Z.
(TODO do we even need this much explanation?
Or maybe ``plainly'' is the wrong way to put it.)
...
This marks another difference from
...
In other Z-related news, Curl Thru can be defined
as a 1/2 emulate Crossfire.
% note how I resist saying ``in other newz'' here. :)
% TODO was ``likewise'' better?  it didn't seem likewise any more,
% once I moved the other paragraphs above it.
